function CCreditsPanel(){
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oLinkOutline = new createjs.Text("www.itechnology.rs", "34px " + FONT_GAME, "#000");
	...
	_oLinkOutline.x = CANVAS_WIDTH/2;
        ...
        _oLink = new createjs.Text("www.itechnology.rs", "34px " + FONT_GAME, "#fff");
    ...
    this._onLogoButRelease = function(){
        window.open("http://itechnology.rs/","_blank");
    };
